## File 'gear_reef_fisheries_model.R'
## 
...
##
## Description: Coral reef fisheries model of nine functional groups to test biomass and catch response to various gear-based
##              management scenarios. The model losely represents the Wakatobi coral reef fishery in Indonesia, where certain 
